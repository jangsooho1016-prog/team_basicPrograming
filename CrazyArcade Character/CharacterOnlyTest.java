...
import java.util.ArrayList;         // ★ 이미지 로딩용
import java.util.List;                 // ★ 스윙 UI
...
public class CharacterOnlyTest extends JFrame {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(CharacterOnlyTest::new);
    }
    ...
    static class TestPanel extends JPanel implements KeyListener, Runnable {
        ...
        public TestPanel() {
            ...
            // 1P — 배찌 (WASD)
            player1 = new Player(1, 1, CharacterType.BAZZI,
                    KeyEvent.VK_W, KeyEvent.VK_S, KeyEvent.VK_A, KeyEvent.VK_D);

            // 2P — 디지니 (방향키)
            player2 = new Player(MAP_WIDTH - 2, MAP_HEIGHT - 2, CharacterType.DIZNI,
    ...
    static class Player {
        ...
        Player(int tx,int ty,CharacterType t,int up,int down,int left,int right){
        ...
        private void loadSpritesForType() {
            if (type == CharacterType.BAZZI) {
                walkRightStrip = new SpriteStrip("res/BlueBazzi_Right.bmp", 5);
                walkLeftStrip  = new SpriteStrip("res/BlueBazzi_Left.bmp", 5);
                walkUpStrip    = new SpriteStrip("res/BlueBazzi_Up.bmp", 5);
                walkDownStrip  = new SpriteStrip("res/BlueBazzi_Down.bmp", 5);
            } else if (type == CharacterType.DIZNI) {
                walkRightStrip = new SpriteStrip("res/BlueDizni_Right.bmp", 5);
                walkLeftStrip  = new SpriteStrip("res/BlueDizni_Left.bmp", 5);
                walkUpStrip    = new SpriteStrip("res/BlueDizni_Up.bmp", 5);
                walkDownStrip  = new SpriteStrip("res/BlueDizni_Down.bmp", 5);
            }
        }
